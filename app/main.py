...
active_sessions = {} # {session_id: chatbot_instance}
...
#     if "No captions" in transcript or "error" in transcript:
...
#     return {"message": "Video loaded successfully.", "session_id": session_id}
